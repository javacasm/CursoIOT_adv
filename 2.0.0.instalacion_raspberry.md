...
* IDE Thonny: Instalado por defecto en raspberry pi, para instalación https://thonny.org


* VSCode:  [Descarga](https://code.visualstudio.com/download) Versión ARM para Rsudo aspberry Pi ¿64 o 32? y lo instalamos:
